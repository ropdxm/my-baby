  ...
  return (
    ...
    >
      ...
      <div className="-mt-36 flex flex-col items-center justify-center sm:-mt-20 lg:my-40 lg:-mt-2 lg:py-40 ">
        ...
        >
          <AnimatedWords
            title="DULAT ZHANBYRSHYN"
            style="inline-block overflow-hidden pt-1 -mr-4 sm:-mr-5 md:-mr-7 lg:-mr-9 -mb-1 sm:-mb-2 md:-mb-3 lg:-mb-4 lg:text-[180px] sm:text-[100px]"
          />
          {/* <motion.div
